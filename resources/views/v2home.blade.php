...
@section('content')
        ...
        <div class="menu-content-body" style="overflow-x: scroll;overflow-y: hidden;width: 100%;height: 100%;">
            ...
            <!-- Modal -->
            <div id="itemDetail" class="modal itemDetail" role="dialog" data-backdrop="static" data-keyboard="false"> <!-- data-keyboard="false" data-backdrop="static" -->
                <div class="modal-dialog modal-sm" style="top: 0em;width:594px;">
				
                    <div class="modal-content" style="height: 660px;padding: 16px;background-color: #333333;border: 1px solid #f4d164;border-radius: 10px;color: white;">
					<div class="row">
						<div class="col-md-6" style="padding-right: 0px;">
							...
							<div style="margin-top: 48px;height: 72px;margin-bottom: 60px;">
								...
								<div class="qbox" style="background-color: #ffffff;color: black;text-align: center;font-size: 40px; padding-top: 0px;">
									...
									<div data-status="0" class="qbox quantity_item" style="background-color: #ffffff;color: black;text-align: center;font-size: 40px;padding-top: 5px;">1</div>
								</div>
					...
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-12">
							<div class="form-group">
							  <label for="note" style="font-size: 23px; color: #F5D265;">備考</label>
							  <textarea class="form-control note" rows="5" id="note" style="resize: none;font-size:  22px;"></textarea>
							</div>
							
							<div style="margin: auto; width: 50%;">
								<button class="btn-menu btn-num btn-placeOrder btn-close" data-dismiss="modal">閉じる</button>							
							</div>
						</div>
					</div>
...
@section('script')
    ...
    {{ Html::script('js/scripts/v2/buster_menu.js') }}
    {{ Html::script('js/scripts/v2/content-menu.js') }}
    {{ Html::script('js/scripts/v2/buster_cart.js') }}
    <script>
    (function (global) {
