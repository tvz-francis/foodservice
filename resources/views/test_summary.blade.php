    ...
    <table style="width: 100%;">
        <thead style="font-size: 20px;">
            <tr style="height: 32px;">
                <td style="width: 538px;">ITEMS</td>
                <td style="width: 367px;">QTY</td>
                <td style="width: 86px;">PRICE</td>
            </tr>
        </thead>
        <tbody>
                    ...
                    <div style="width: 100%;height: 500px;overflow: scroll;">
                        ...
                        @for($i = 0; $i <= 9; $i++)
                            ...
                            <tr style="height:77px;">
                                ...
                                <td style="width: 382px;padding: 0px 15px 0px 0px;">

                                    <!-- s BUTTON -->

                                    <button class="btn btn-default" style="border-radius: 56px;background: #ffffff;text-decoration: none;width: 100%;height: 100%;text-align: center;padding: 0;">
                                        ...
                                        <div class="row" style="margin: 0 auto;height: 53px;display: inline-flex;padding: 0;">
                                            ...
                                            <div class="" style="height: 40px;width: 40px;">
                                                <img src="{{ url('/image/icons/Item-Negative.png') }}" id="quantityMinus" style="width: 54px;margin-top: -3px;margin-left: -7px;" />
                                            </div>
                                            ...
                                            <div class="" style="height: 40px;width: 40px;">
                                                <img src="{{ url('/image/icons/Item-Positive.png') }}" id="quantityAdd" style="width: 54px;margin-top: -3px;margin-left: -7px;" />
                                            </div>
                                            <div class="" style="height: 40px;width: 40px;">
                                                <a style="padding: 0;">
                                ...
                                <td style="display: inline-flex;padding: 0;">
                                    ...
                                    <div>
                                        <span style="width: 12px;text-align: center;">
                                            <i class="fa fa-times fa-1" aria-hidden="true" style="color: #917F1A;font-size: 20px;"></i>
                                        </span>
                                    </div>
            ...
            <tr style="height: 73px;">
                <td colspan="3">
                    ...
                    <div style="width: 160px;float: right;">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal" style="width: 100%;border-radius: 25px;border: 2px solid #634e11;background-color: #a67c00;color: white;height: 48px;font-size: 15px;">Continue</button>
...
<!-- TY Modal -->
<div id="ty_modal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-sm" style="top: 8em;width:387px;">

         <!-- Modal content-->
        <div class="modal-content" style="height: 342px;padding: 0px 30px 0px 30px;">

            <!-- Content header-->
            <div class="modal-header" style="border: 0px;padding: 0px;">

                <div>
                    <h2 style="margin: 0;height: 40px;font-size: 30px;text-align: center;padding-top: 5px;">Congratulations</h2>
                    <p style="    font-size: 17px;margin: 0;text-align: left;word-break: break-word;padding-top: 40px;">Your order has been successfully submitted</p>
                </div>
            ...
            <div class="modal-body" style="padding: 0;text-align: center;">
                ...
                <div style="padding-top: 20px;">
                    <i class="fa fa-check-circle-o fa-5" aria-hidden="true" style="color: #0B9838;font-size: 117px;height: 100px;width: 100px;"></i>
                </div>

            </div>

            <!-- Content footer -->
            <div class="modal-footer" style="text-align: center;border-top: 0px;padding-top: 22px;padding: 30px 0px 0px 0px;">

                <div style="width: 150px;margin: auto;">
                    <button type="button" class="btn btn-default" data-dismiss="modal" style="width: 100%;border-radius: 25px;border: 2px solid #634e11;background-color: #a67c00;color: white;height: 48px;font-size: 15px;">OK</button>
                </div>
    ...
    <div class="modal-dialog modal-sm" style="top: 8em;width:387px;">
        ...
        <div class="modal-content" style="height: 342px;padding: 0px 30px 0px 30px;">
            ...
            <div class="modal-header" style="border: 0px;padding: 0px;">
                ...
                <div>
                    <h2 style="margin: 0;height: 40px;font-size: 30px;text-align: center;padding-top: 5px;">Success</h2>
                    <p style="    font-size: 17px;margin: 0;text-align: center;word-break: break-word;padding-top: 40px;">Your order has been cancelled</p>
                </div>
...
@section('script')
    {{ Html::script('js/scripts/buster_summary.js') }}
@endsection